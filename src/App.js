          ...
          <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
            ...
            <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
              ...
              <p className="text-sm font-light text-gray-400">
                This offer is valid until August 3rd or as long as stock lasts!
              </p>
            </div>
            <div className="group">
              <button className="transition-all duration-150 w-full bg-blue-700 text-white border-b-8 border-b-blue-700 rounded-lg group-hover:border-t-8 group-hover:border-b-0 group-hover:bg-blue-700 group-hover:border-t-blue-700 group-hover:shadow-lg">
            ...
            <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
              <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150">
                <img src={weight} alt="balanza boton" className="w-8"/>
                <span>Add to cart</span>
              </button>
              <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-150">
                <img src={heart} alt="balanza boton" className="w-8"/>
